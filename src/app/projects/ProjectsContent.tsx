...
const featured: FeaturedProject[] = [
  {
    ...
    descriptionEn: 'An AI-powered stock analysis and trading platform built with React 18, TypeScript, and Vite. Users can interact with charts to extract range data, feed it to LLMs for structured conversations. Features a RAG pipeline for improved response quality. Backend built with Node.js, Express, and Prisma, sourcing data from yfinance.',
...
const others: OtherProject[] = [
  ...
  {
    name: '易盘点 SaaS 平台',
    nameEn: 'YiPanDian SaaS',
    descriptionZh: '固定资产管理 SaaS 平台，涵盖 Web 管理端、钉钉小程序与微信小程序多端，基于 Taro 框架实现跨端开发。',
    descriptionEn: 'A fixed asset management SaaS platform covering a web admin panel, DingTalk mini-program, and WeChat mini-program, built with the Taro cross-platform framework.',
  ...
  {
    name: 'Ainvest 移动端图表库',
    nameEn: 'Ainvest Chart Kit',
    descriptionZh: '在同花顺期间，为海外 F10 移动端提供标准化基础图表组件，减少业务前端的图表配置开发量，提高研发效率。',
    descriptionEn: 'Standardized base chart components for the overseas F10 mobile app at Tonghuashun, reducing chart configuration overhead and improving developer productivity.',
  ...
  {
    name: '带时间轴的动态图表',
    nameEn: 'Timeline Chart',
    descriptionZh: '在同花顺期间，基于金融数据时间属性，设计并实现带时间轴的动态矩形树图、柱状图、折线图。',
    descriptionEn: 'Dynamic treemap, bar chart, and line chart with a time-axis scrubber for financial data, built at Tonghuashun.',
  ...
  },
  {
    name: 'BDVis 数据安全可视分析',
    nameEn: 'BDVis',
    descriptionZh: 'ChinaVis 2022 参赛作品，使用 Neo4j 图数据库进行分析，结合 React + D3.js 构建可视化工具辅助信息安全数据分析。',
    descriptionEn: 'ChinaVis 2022 competition entry — a visual analytics tool for cybersecurity data using Neo4j graph database with React and D3.js.',
  ...
  },
  {
    name: 'SCVis 传感器异常可视化',
    nameEn: 'SCVis',
    descriptionZh: 'ChinaVis 2019 参赛作品，设计并制作实时可视化监控平台，荣获一等奖（2018 年参赛获优秀奖）。',
    descriptionEn: 'ChinaVis 2019 entry — a real-time sensor anomaly visualization platform. Won 1st prize (Excellence Award in 2018).',
  ...
  },
  {
    ...
    nameEn: 'HaiKouTVis',
    descriptionZh: '参加 2019 CCF-BDCI 交通流量时空演变特征可视分析比赛，基于 Echarts 和 D3.js 开发交通流量分析平台，获三等奖。',
    descriptionEn: '2019 CCF-BDCI competition entry — a traffic flow spatio-temporal visualization platform built with Echarts and D3.js. Won 3rd prize.',
...
const AgentIcon = () => (
  <svg width="1em" height="1em" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 26 22" fill="currentColor">
    <g fill="currentColor">
...
export default function ProjectsContent() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-12">
      <div className="mb-10">
        <h1 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-1">{t.title}</h1>
            ...
            <li key={project.name}>
              <div className="flex items-center justify-between px-2 py-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800/40 transition-colors">
                <div className="flex items-center gap-3 min-w-0">
                  <span className="font-mono text-sm text-gray-800 dark:text-gray-200 shrink-0">
                    {lang === 'zh' ? project.name : (project.nameEn ?? project.name)}
                  </span>
                ...
                <div className="flex items-center gap-3 ml-4 flex-shrink-0">
                  ...
                  {project.url && (
                    <a href={project.url} target="_blank" rel="noopener noreferrer" className="text-gray-300 dark:text-gray-600 hover:text-gray-700 dark:hover:text-gray-300 transition-colors" aria-label={t.visitProject}>
                      <ExternalIcon />
                    </a>
                  )}
                </div>
